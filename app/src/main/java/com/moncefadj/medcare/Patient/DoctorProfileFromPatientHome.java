...
public class DoctorProfileFromPatientHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        descy = findViewById(R.id.doctor_description);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot day : snapshot.getChildren()) {
                        ...
                        showButton(time, available, dayRef);
    ...
    private void showButton(String time, String available, DatabaseReference dayRef) {
    ...
    private void createAlertDialog(String time, DatabaseReference dayRef) {
    ...
    private void prendreRdv(String YN, String time, DatabaseReference dayRef) {
        ...
        getPatientName(time, dayRef);

    }

    private void getPatientName(String time, DatabaseReference dayRef) {

        DatabaseReference patRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Patients");
        patRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot pat : snapshot.getChildren()) {

                        String nom = pat.child("name").getValue(String.class);
    ...
    private void addPatient(String time, String nom) {

        HashMap<String, Object> mapRdvDudes = new HashMap<>();
        mapRdvDudes.put("name", nom);
        mapRdvDudes.put("heure", time);
        doctorRef.child("PatientsWithRdv").child(uidPatient).updateChildren(mapRdvDudes);
